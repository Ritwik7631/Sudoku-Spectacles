...
// Add type declaration for getDisplayMedia
declare global {
...
export default class Processor extends (EventEmitter as {
  ...
  /**
   * Start streaming video from screen sharing
  ...
  async startVideo(video: HTMLVideoElement) {
    ...
    try {
      ...
      stream.getVideoTracks()[0].onended = () => {
        ...
        alert('Screen sharing stopped. Please refresh the page to start again.');
      };
      ...
      alert('Failed to access screen. Please make sure to select a screen to share.');
    }
  }
